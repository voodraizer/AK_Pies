...
def register_keymaps():
	...
	if kc:
		...
		# Normals
		kmi = register_hotkey(kc, "Object Mode", "wm.call_menu_pie", "N", pies.PIE_MT_PieNormals.bl_idname)
		kmi.alt = True
		...
		# Normals
		kmi = register_hotkey(kc, "Mesh", "wm.call_menu_pie", "N", pies.PIE_MT_PieNormals.bl_idname)
		kmi.alt = True
